...
const scrollRevealOption = {
  ...
  ScrollReveal().reveal(".head__container h2", {
    ...scrollRevealOption,
  });
ScrollReveal().reveal(".head__container h1", {
  ...scrollRevealOption,
  delay: 500,
});
ScrollReveal().reveal(".head__container p", {
  ...scrollRevealOption,
  delay: 1000,
});
ScrollReveal().reveal(".head__container .header__btns", {
  ...scrollRevealOption,
  delay: 1500,
});
